    ...
    <section className="bg-mint-green dark:bg-gray-900 p-3 sm:p-5">
      <div className="mx-auto max-w-screen-xl px-4 lg:px-12 mb-[50px]">
        <div className="bg-green dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
          ...
          <button onClick={sortEmissions} className="bg-dark-green text-white font-bold py-2 px-4 rounded">
            Sortieren
            </button>
            ...
            <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
              <div className="flex items-center space-x-3 w-full md:w-auto">
                ...
                >
                  ...
                  <option className="text-white" value="">Alle</option>
                  <option className="text-white" value="true">Countries</option>
                  <option className="text-white" value="false">Companies</option>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {data.filter(row => filterCountry === '' || (filterCountry === 'true' ? row.isCountry : !row.isCountry)).map((row, index) => (
                  <tr
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-white">{row.co2Emission}</td>
                  </tr>
                ))}
              </tbody>
            </table>
